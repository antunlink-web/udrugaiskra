...
const empty: FormState = { firstName: "", lastName: "", email: "", phone: "", note: "" };
...
const WorkshopRegistrationForm = ({
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      <div>
        <label className="block text-xs font-semibold text-foreground/80 mb-1.5">Napomena</label>
        <textarea value={form.note} onChange={update("note")} maxLength={1000} rows={4} placeholder="Vaša poruka (nije obavezno)"
      ...
      <p className="text-[11px] text-muted-foreground">
        Slanjem prijave pristajete da vas kontaktiramo radi dogovora o sudjelovanju.
      </p>
    </form>
  );
};
